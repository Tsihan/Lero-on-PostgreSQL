...
class LeroHelper():
    ...
    def start(self, pool_num):
        ...
        for c_idx, chunk in enumerate(lero_chunks):
            ...
            self.test_benchmark(self.output_query_latency_file + "_" + model_name,use_first_set,use_second_db)
    ...
    def test_benchmark(self, output_file,use_first_set,use_second_db):
        run_args = self.get_run_args()
        if use_first_set:
